const loadServices = () => {
    fetch("https://maxhospital.onrender.com/services/")
      .then((res) => res.json())
  ...
  const loadDoctors = (search) => {
    ...
    console.log(search);
    fetch(
      `https://maxhospital.onrender.com/doctor/list/?search=${
        search ? search : ""
      }`
    )
      .then((res) => res.json())
  ...
  const loadDesignation = () => {
    fetch("https://maxhospital.onrender.com/doctor/designation/")
      .then((res) => res.json())
      .then((data) => {
        data.forEach((item) => {
  ...
  const loadSpecialization = () => {
    fetch("https://maxhospital.onrender.com/doctor/specialization/")
      .then((res) => res.json())
      .then((data) => {
        data.forEach((item) => {
  ...
  const loadReview = () => {
    fetch("https://maxhospital.onrender.com/doctor/review/")
      .then((res) => res.json())
