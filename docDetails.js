const getparams = () => {
    ...
    loadTime(param);
    fetch(`https://maxhospital.onrender.com/doctor/list/${param}`)
      .then((res) => res.json())
      .then((data) => displayDetails(data));
  
    fetch(`https://maxhospital.onrender.com/doctor/review/?doctor_id=${param}`)
      .then((res) => res.json())
  ...
  const loadTime = (id) => {
    fetch(
      `https://maxhospital.onrender.com/doctor/availabletime/?doctor_id=${id}`
    )
      .then((res) => res.json())
      .then((data) => {
        data.forEach((item) => {
  ...
  const handleAppointment = () => {
    ...
    console.log(info);
    fetch("https://maxhospital.onrender.com/appointment/", {
      method: "POST",
  ...
  const loadPatientId = () => {
    ...
    fetch(`https://maxhospital.onrender.com/patient/list/?user_id=${user_id}`)
      .then((res) => res.json())
      .then((data) => {
