const handlePdf = () => {
    ...
    console.log(`https://maxhospital.onrender.com/users/${user_id}`);
    fetch(`https://maxhospital.onrender.com/doctor/list/${doctor_id}`)
      .then((res) => res.json())
      .then((data) => {
        fetch(`https://maxhospital.onrender.com/users/${user_id}`)
          .then((res) => res.json())
          .then((pdData) => {
